...
https://matheustavares.gitlab.io/posts/rewriting-history-101
...
commits". Ok, but you can do it without squashing (and without losing the
...
- Try to write **meaningful commit** that we discussed before. It is hard at
  first, but it will soon become easy and it will pay your effort;

- On you code reviews, also **review the commit history**. Look if, it is clean
  and if it is not, ask to the author of the code to rewrite the history and
  apply those good commit practices;
...
- If you are a senior, **don't tell juniors to do something that you don't
  _actually_ know what it is**, but you are only telling that because _other senior_ told you
...
course it can be useful! But there are
a lot of more useful tools that people don't know, for example, some searching
and debugging tools that I explained [here]({{ site.baseurl}}/posts-en/2023-02-13-git-debug).
