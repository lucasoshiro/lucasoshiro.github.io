...
This page contains a more detailed resumé, not only listing my experiences and
skills but also describing them, how they are important and giving examples.
...
- **2015-2019**: [Bachelor in Computer Science](https://bcc.ime.usp.br/) at [University of São Paulo](https://usp.br);
- **2022-present**: Studying for a [master's degree in Computer Science](https://www.ime.usp.br/pos-computacao/) at
  [University of São Paulo](https://usp.br);

Formerly, I started other courses that I didn't finished:

- **2014**: [Systems Analysis and Development](https://www.cps.sp.gov.br/cursos-fatec/analise-e-desenvolvimento-de-sistemas/) at [Fatec São Paulo](https://www.fatecsp.br/)
...
- **[Loggi](https://www.loggi.com/)**: a Brazilian logistics unicorn
  - **2020**: Software Engineer Trainee
  - **2020-2021**: Junior Software Engineer
  - **2021-2022**: Software Engineer

- **[IME-USP](https://www.ime.usp.br/)**: Institute of Mathematics and Statistics of University of São Paulo
  - **2023-2024**: Teaching assistant
  - **2024**: Lecturer

- **[FAPESP](https://fapesp.br/)**: The São Paulo Research Foundation
...
- **[Google Summer of Code](https://summerofcode.withgoogle.com/)**: Mentoring
  program sponsored by Google for introducing new contributors to open-source
  projects
...
- **C++** (Competent): During my master's research I needed to deal with the
  ...
  [external module](https://github.com/lucasoshiro/GridGooseSV/actions) for it.
